...
protected:
  void SetUp() override
  {
    ...
    context_options.auto_initialize_logging(false).set_domain_id(kDomain1);
...
TEST_F(TestGenericServiceBridge, bridge_service_string_api)
{
  ...
  bridge.bridge_service("add_two_ints", "example_interfaces/srv/AddTwoInts", kDomain1, kDomain2);
